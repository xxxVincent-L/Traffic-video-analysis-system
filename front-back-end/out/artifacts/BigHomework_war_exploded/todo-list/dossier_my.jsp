...
<div class="title"><h2>个人档案</h2></div>
    ...
    <div class="resource_main">
        <div class="resource_main_top">
            <div class="l_left resource_box"><a href="myfile_data.jsp" target="right">
                ...
                <p style="text-align: center;font-weight: bold">私人资料</p>
            ...
            <div class="l_left resource_box"><a href="myfile_data.jsp" target="right">
                ...
                <p style="text-align: center;font-weight: bold">工作文档</p>
            ...
            <div class="l_left resource_box"><a href="myfile_data.jsp" target="right">
                ...
                <p style="text-align: center;font-weight: bold">项目资料</p>
