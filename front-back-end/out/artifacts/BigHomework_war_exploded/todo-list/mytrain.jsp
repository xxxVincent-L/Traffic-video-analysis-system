...
<div class="title"><h2>我的培训</h2></div>
<div class="query">
    <div class="tabe_bot">
        ...
        <div class="l_left"><label>培训时间：</label><input id="demo" placeholder="输入培训时间" /></div>
...
<div class="table-operate ue-clear">
    ...
    <a href="javascript:;" class="out" onclick="out(id)">导出</a>
...
<script src="js/mytrain.js"></script>
