...
video_path_dir = "../webm"  # 视频路径
classifier_path = "C:/Users/17197/Desktop/demo/classifier/myhaar.xml"  # 分类器路径
...
def process(file_name):
    ...
    output=[]
    count=0
    for car in info2store.keys():
        count+=1
        name="{}.jpg".format(count)
        path="C:/Users/17197/Desktop/programfiles/car/Traffic-video-analysis-system/front-back-end/out/artifacts/BigHomework_war_exploded/img/"+name
        cv2.imwrite(path,info2store[car]["image"])
        output.append(name)
    return output
if __name__ == '__main__':
    video_names = sorted(os.listdir(os.path.abspath(video_path_dir)))
